  ...
  return (
    <section id="contact" className="bg-black py-24 md:py-32 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-[0.9fr_1.3fr_0.9fr] gap-10 items-start">
        ...
        <div>
          ...
          <div className="mt-8 space-y-6">
            <div className="flex items-start gap-4">
              ...
              <a href={SITE.mapsShareUrl} target="_blank" rel="noreferrer" className="text-white text-base hover:text-blue-400 transition-colors">
                {SITE.address}
              </a>
            </div>
            <div className="flex items-start gap-4">
              <Phone className="w-5 h-5 text-blue-400 shrink-0 mt-0.5" strokeWidth={1.5} />
              <a href={`tel:${SITE.phoneRaw}`} className="text-white text-base hover:text-blue-400 transition-colors">
                {SITE.phone}
              </a>
            </div>
            <div className="flex items-start gap-4">
              <Mail className="w-5 h-5 text-blue-400 shrink-0 mt-0.5" strokeWidth={1.5} />
              <a href={`mailto:${SITE.email}`} className="text-white text-base hover:underline break-all">
                {SITE.email}
              </a>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div className="text-white text-base">
                {t('contact.hoursDays')}
                <div className="text-white/70 text-sm mt-1">{t('contact.hoursTime')}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* CENTER: Map */}
        <div className="relative w-full rounded-md overflow-hidden border border-white/10 order-last lg:order-none" style={{ minHeight: 380 }}>
          <iframe
          ...
          <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(circle at center, transparent 45%, rgba(0,0,0,0.5) 100%)' }} />
        </div>
