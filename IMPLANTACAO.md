...
- [ ] O primeiro build em Next: `https://cleanstationcar.com/lavagem-premium-braga/`
      abre a página da lavagem, e o mesmo endereço sem a barra no fim vai lá
      ter — com um `301` ou direto, conforme a Netlify.
